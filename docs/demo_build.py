...
def build():
    ...
    import main as _m
    webui._State.version = "demo"   # 页脚魔法值:静态演示态不外显版本（恒 V1.0 呈现面零内部 build 号）
    ...
    page = webui._page_html(webui._State.version)
    assert "__PAGEVER__" not in page, "页面代际令牌未替换（横幅会误报）"
